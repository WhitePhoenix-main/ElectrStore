...
namespace ElectrStore.Migrations
{
    /// <inheritdoc />
    public partial class InitialCraete : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(100)", nullable: false),
                    CategoryId = table.Column<string>(type: "varchar(150)", nullable: true),
                    ...
                    IsHotDeal = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishListRecord", x => x.Id);
                });
